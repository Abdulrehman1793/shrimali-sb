...
public class Member {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "paternal_gotra_id")
    private Gotra paternalGotra; // Birth Gotra (from Father)

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "maternal_gotra_id")
    private Gotra maternalGotra; // Mother's Birth Gotra (Naniyal)

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "paternal_grandmother_gotra_id")
    private Gotra paternalGrandmotherGotra; // Dadi's Birth Gotra

    /**
     * For married females, this stores the husband's gotra.
     * For males/unmarried females, this is usually null or same as paternalGotra.
     */
    @ManyToOne(fetch = FetchType.LAZY)
